public class About extends MoreInfo{
    ...
    String howToNavigateDescription = "When a user uses the SRAS platform, a home page will appear and they will have the " +
            "option to input which of the five features they would like to access. %nIf the user inputs 1, they will access " +
            "Statistics; if the user inputs 2, they will access Additional Resources; if the user inputs 3, they will access " +
            "%nAbout (the current option you are in); if the user inputs 4, they will access File Report; and if the user " +
            "inputs 5, they will access Access Report. \n" +
            "\n" +
