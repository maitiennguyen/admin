public class AdditionalResources extends MoreInfo{
    ...
    String campusSafetyDescription = "Campus Safety is committed to creating a safe environment on the Colorado College campus " +
            "by providing educational programs, services, support, emergency response, and high visibility patrol for the " +
    ...
    String counselingCenterDescription = "The Counseling Center provides mental health services such as counseling, " +
            ...
            "the first six sessions of counseling, but there are fees for psychiatrist medication services. If you have " +
            "questions about the details of your mental health coverage and benefits, please consult your health insurance " +
